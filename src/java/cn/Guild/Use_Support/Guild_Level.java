...
public class Guild_Level {
    ...
    public int get_Guild_Level(String Guild_name){
        ...
        int value= Guild_Setup.Get_Guild_Yaml(Guild_name).getInt(Guild_name+".Level");
    ...
    public boolean Up_Guild_Level(String Guild_name){
        if(Guild_Level_Cache.containsKey(Guild_name)){
            ...
            Guild_Setup.Get_Guild_Yaml(Guild_name).set(Guild_name+".Level",Guild_Level_Cache.get(Guild_name));
        }else {
            Guild_Setup.Get_Guild_Yaml(Guild_name).set(Guild_name+".Level",Guild_Setup.Get_Guild_Yaml(Guild_name).getInt(Guild_name+".Level")+1);
        }
        return true;
    }
